...
def check_metadata(path, channel_names):
    ...
    marker_info_path = os.path.join(os.getcwd(),'data','marker_info.csv')
    ...
    output_csv_path = os.path.join(os.getcwd(),'data','marker_info_with_metadata.csv') # TODO change output_csv_path to another directory
