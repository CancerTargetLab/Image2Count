...
```py
path = 'out/'
target = '/path/to/data/raw/CRC_1p/CRC_1p_measurements.csv'
num_subgraphs_per_graph = 900 
num_hops_per_subgraph = [1, 2, 3, 5, 8, 11]  

name = 'crc_1p_24_6_[0-9]_all.h5ad'   #crc_1p_24_6_mean_all.h5ad for the merged prediction data
out = 'figures/crc_1p/24_6/'
